    ...
    <el-container>
      ...
      <el-main height="">
        ...
        <div>
          <el-header height="">
            <!-- Header content -->
            <el-button type="text" @click="componentName='Detail'">活动详情</el-button>
            <el-button type="text" @click="componentName='Member'">活动成员</el-button>
          </el-header>
          <el-main height="">
            <!-- Main content -->
            <el-row>
              ...
              <el-col :span="6">
                <Owner :ownerId="activity.ownerId"></Owner>
              </el-col>
            </el-row>
          </el-main>
        </div>
...
<script>
  ...
  import Detail from './thirdary/Detail'
  import Member from './thirdary/Member'
  import Owner from './thirdary/Owner'
